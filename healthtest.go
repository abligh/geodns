...
func (ht *HealthTest) String() string {
	return fmt.Sprintf("%s/%v/%s", ht.ipAddress.String(), ht.HealthTestParameters, (*ht.tester).String())
}
...
func (t TcpHealthTester) String() string {
	return fmt.Sprintf("%T/%d", t, t.port)
}
...
func (t NtpHealthTester) String() string {
	return fmt.Sprintf("%T/%d", t, t.maxStratum)
}
